...
ggplot()+
  ...
  geom_point(data = dataday_filtro, aes(x = long_estacion_destino,
                              y = lat_estacion_destino), color = "red")+
  geom_point(data = dataday_filtro, aes(x = long_estacion_origen,
                              y = lat_estacion_origen), color = "green", alpha = 0.2)

  #geom_sf(data = calles, aes(color = bicisenda))
```
